 ...
 * Plugin URI: http://www.voyagebc.com/voyage-plus
...
?>
	<div id="voyage-wrapper" class="container_12">	
		...
		<div class="voyage-pane clearfix"><div class="grid_12">
			...
			<p>The documentation is available from <a href="<?php _e('http://www.voyagebc.com/voyage-plus-documentation/','voyageplus'); ?>" target="_blank"><?php _e('Voyage Plus Documentation','voyageplus'); ?></a>.</p>
...
function voyageplus_fields_array() {
	$options = array(
...
public function voyageplus_get_options() {
...
function voyageplus_display( $option_array, $options ) {
